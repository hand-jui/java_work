...
//		key와 value 구조로 데이터를 저장한다.
		...
		Hashtable<String, String> map2 = new Hashtable<>(); // v - null 값 허용X
...
//		값 꺼내는 법 - key 값으로 value 값을 꺼낼 수 있다
		System.out.println(map1.get("B03"));
		System.out.println(map1.get("C01"));
		System.out.println(map1.get("b01")); // B01과 b01은 다름 -> 없는 key 값을 요청하면 null이 반환
...
//		map 원래 순서가 없지만 잠깐 응용하면 key 값으로 for문 정도는 활용할 수 있다.
...
//		map 값을 꺼낼 때 key 값으로 접근  -> value 반환
//		String str = map1.get("A01");
		for (String key : map1.keySet()) {
			System.out.println("key: " + key); // 반복 돌면서 key 값 확인
